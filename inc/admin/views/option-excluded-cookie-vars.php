...
$option_excluded_cookie_vars = get_option( 'scm_option_excluded_cookie_vars', '' );

?>

<div>
	<div class="scm-option-item">
		<textarea name="scm_option_excluded_cookie_vars" class="scm-texatrea" rows="3" cols="30"><?php echo $option_excluded_cookie_vars; ?></textarea>
	</div>	
</div>
